    ...
    <main className="min-h-screen pt-[88px] flex items-center justify-center bg-background px-4">
      <div className="border border-outline-variant p-8 flex flex-col items-center gap-6 bg-surface-container max-w-md w-full shadow-2xl">
        <div className="flex flex-col items-center text-center gap-2 mb-4">
          ...
          <p className="font-body-md text-on-surface-variant">Acceso exclusivo para administradores de La Legión.</p>
        </div>
        
        <button 
          onClick={handleLogin} 
          className="w-full bg-white text-black px-6 py-4 uppercase font-label-technical font-bold flex items-center justify-center gap-3 hover:bg-gray-200 transition-colors"
        >
          {/* Google G icon approximate */}
